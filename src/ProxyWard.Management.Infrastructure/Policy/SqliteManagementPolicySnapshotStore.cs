...
public sealed class SqliteManagementPolicySnapshotStore : IManagementPolicySnapshotStore
{
    private readonly SqlitePolicyStore _policyStore;

    public SqliteManagementPolicySnapshotStore(SqlitePolicyStore policyStore)
    {
